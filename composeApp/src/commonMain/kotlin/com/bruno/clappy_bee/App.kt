...
import clappybee.composeapp.generated.resources.background_db
import clappybee.composeapp.generated.resources.goku2
import clappybee.composeapp.generated.resources.pipe
import clappybee.composeapp.generated.resources.pipe_cap
import clappybee.composeapp.generated.resources.run
import com.bruno.clappy_bee.domain.Game
import com.bruno.clappy_bee.domain.GameStatus
import com.bruno.clappy_bee.ui.orange
import com.bruno.clappy_bee.util.ChewyFontFamily
import com.bruno.clappy_bee.util.Platform
import com.bruno.clappy_bee.util.getPlatform
...
fun App() {
    MaterialTheme {
        ...
        val spriteSpec = remember {
            SpriteSpec(
                screenWidth = screenWidht.toFloat(),
                default = SpriteSheet(
                    frameWidth = BEE_FRAME_SIZE,
                    frameHeight = BEE_FRAME_SIZE,
                    image = Res.drawable.goku2
                )
            )
        }
        ...
        Box(
            ...
            Image(
                modifier = Modifier.fillMaxSize(),
                painter = painterResource(Res.drawable.background_db),
        ...
        androidx.compose.foundation.Canvas(
            modifier = Modifier
                ...
                .onGloballyPositioned {
                    val size = it.size
                    if (screenWidht != size.width || screenHeight != size.height) {
